...
--               Logiche/10619348_RL_proj/10619348_RL_proj.sim/sim_1/synth/func/xsim/auto_tb_func_synth.vhd}
...
architecture STRUCTURE of clock_controller is
  ...
  attribute SOFT_HLUTNM of ctrl_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of get_i_1 : label is "soft_lutpair4";
begin
  counter <= \^counter\;
...
entity flipflop_td is
  port (
    ...
    \out_ffd_reg[6]_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of fsm_counter is
  ...
  attribute SOFT_HLUTNM of \o_address[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_address[2]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of start_comparing_i_3 : label is "soft_lutpair3";
begin
...
architecture STRUCTURE of project_reti_logiche is
  ...
  signal fixed_memory_n_0 : STD_LOGIC;
  signal fixed_memory_n_1 : STD_LOGIC;
  signal fixed_memory_n_2 : STD_LOGIC;
  signal fixed_memory_n_3 : STD_LOGIC;
  signal fixed_memory_n_4 : STD_LOGIC;
  signal fixed_memory_n_5 : STD_LOGIC;
  signal fixed_memory_n_6 : STD_LOGIC;
  signal fixed_memory_n_7 : STD_LOGIC;
  ...
  signal logic_controller_n_4 : STD_LOGIC;
  ...
  signal variable_memory_n_0 : STD_LOGIC;
  signal variable_memory_n_1 : STD_LOGIC;
  signal variable_memory_n_10 : STD_LOGIC;
  signal variable_memory_n_11 : STD_LOGIC;
  signal variable_memory_n_3 : STD_LOGIC;
  signal variable_memory_n_4 : STD_LOGIC;
  signal variable_memory_n_5 : STD_LOGIC;
  signal variable_memory_n_6 : STD_LOGIC;
  signal variable_memory_n_7 : STD_LOGIC;
  signal variable_memory_n_8 : STD_LOGIC;
  signal variable_memory_n_9 : STD_LOGIC;
  signal zone : STD_LOGIC_VECTOR ( 3 downto 2 );
begin
arithmetic_function: entity work.compare_and_codify
     port map (
      D(1) => counter_n_7,
      D(0) => counter_n_8,
      Q => o_we_OBUF,
      SR(0) => fixed_memory_n_0,
      ...
      \o_data_reg[6]_0\(6) => fixed_memory_n_2,
      \o_data_reg[6]_0\(5) => variable_memory_n_1,
      \o_data_reg[6]_0\(4) => fixed_memory_n_3,
      \o_data_reg[6]_0\(3) => fixed_memory_n_4,
      \o_data_reg[6]_0\(2) => fixed_memory_n_5,
      \o_data_reg[6]_0\(1) => fixed_memory_n_6,
      \o_data_reg[6]_0\(0) => fixed_memory_n_7,
...
counter: entity work.fsm_counter
     port map (
      D(1) => counter_n_7,
      D(0) => counter_n_8,
      E(0) => counter_n_12,
...
fixed_memory: entity work.flipflop_td
     port map (
      D(6 downto 0) => i_data_IBUF(6 downto 0),
      E(0) => get,
      Q(0) => fixed(5),
      S(0) => variable_memory_n_3,
      SR(0) => fixed_memory_n_0,
      finished => finished,
      i_clk_IBUF_BUFG => i_clk_IBUF_BUFG,
      i_rst_IBUF => i_rst_IBUF,
      ...
      o_done_reg_i_3_0(6) => variable_memory_n_5,
      o_done_reg_i_3_0(5) => variable_memory_n_6,
      o_done_reg_i_3_0(4) => variable_memory_n_7,
      o_done_reg_i_3_0(3) => variable_memory_n_8,
      o_done_reg_i_3_0(2) => variable_memory_n_9,
      o_done_reg_i_3_0(1) => variable_memory_n_10,
      o_done_reg_i_3_0(0) => variable_memory_n_11,
      o_zone(0) => o_zone(0),
      \out_ffd_reg[3]_0\ => fixed_memory_n_1,
      \out_ffd_reg[6]_0\(0) => ctrl1,
      start_comparing => start_comparing,
      start_comparing_reg(5) => fixed_memory_n_2,
      start_comparing_reg(4) => fixed_memory_n_3,
      start_comparing_reg(3) => fixed_memory_n_4,
      start_comparing_reg(2) => fixed_memory_n_5,
      start_comparing_reg(1) => fixed_memory_n_6,
      start_comparing_reg(0) => fixed_memory_n_7
    );
...
logic_controller: entity work.clock_controller
     port map (
      E(0) => get,
      SR(0) => ctrl1,
      cac_controller => cac_controller,
...
variable_memory: entity work.flipflop_variable
     port map (
      ...
      \o_zone_reg[0]_0\(0) => variable_memory_n_1,
      \o_zone_reg[0]_1\(0) => o_zone(0),
      \o_zone_reg[0]_2\ => counter_n_9,
      \o_zone_reg[1]_0\ => counter_n_2,
      \o_zone_reg[2]_0\ => variable_memory_n_4,
      \out_ffd_reg[6]_0\(6) => variable_memory_n_5,
      \out_ffd_reg[6]_0\(5) => variable_memory_n_6,
      \out_ffd_reg[6]_0\(4) => variable_memory_n_7,
      \out_ffd_reg[6]_0\(3) => variable_memory_n_8,
      \out_ffd_reg[6]_0\(2) => variable_memory_n_9,
      \out_ffd_reg[6]_0\(1) => variable_memory_n_10,
      \out_ffd_reg[6]_0\(0) => variable_memory_n_11,
      start_comparing => start_comparing,
      zone(1 downto 0) => zone(3 downto 2)
    );
end STRUCTURE;
